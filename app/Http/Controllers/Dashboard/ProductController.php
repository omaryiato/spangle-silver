    ...
    public function addNewProduct(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                ...
                'product_material'       => 'bail|required|integer|exist:lookup_values,id',
                'product_stone'       => 'bail|required|integer|exist:lookup_values,id',
                ...
                'product_variants.color_id'       => 'bail|required|integer|exist:lookup_values,id',
                'product_variants.size_id'       => 'bail|required|integer|exist:lookup_values,id',
